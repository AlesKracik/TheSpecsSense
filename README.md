...
| # | File | What it covers |
|---|---|---|
| 1 | [i-see-dead-specs.md](i-see-dead-specs.md) | Overview: what Specs Sense is, why it exists, the irreducible role of human judgment |
| 2 | [its-elementary.md](its-elementary.md) | The algorithm: nine rounds of mechanical gap-discovery, iterated to a fixed point |
| 3 | [behind-the-curtain.md](behind-the-curtain.md) | Physical implementation: Git, JSON, agents, orchestrator, readback, diffs |
| 4 | [ghosts-in-the-code.md](ghosts-in-the-code.md) | Connecting spec to code: conformance layers and brownfield retrofit |

## Where to start

| If you are... | Read first |
|---|---|
| Skeptical, want the pitch in fifteen minutes | `i-see-dead-specs` |
| About to run the methodology on a real system | `its-elementary` |
| Building the tooling and infrastructure | `behind-the-curtain` |
| Retrofitting an existing codebase | `ghosts-in-the-code` |
